    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(verbose_name='contact', to='shoop.Contact')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', enumfields.fields.EnumIntegerField(default=0, enum=shoop.utils.analog.LogEntryKind, verbose_name='log entry kind')),
                ('extra', jsonfield.fields.JSONField(null=True, verbose_name='extra data', blank=True)),
                ('target', models.ForeignKey(related_name='log_entries', verbose_name='target', to='shoop_mailchimp.MailchimpContact')),
