...
def remove_duplicates(apps, schema_editor):
    ...
    MailchimpContact = apps.get_model('shoop_mailchimp', 'MailchimpContact')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('shoop_mailchimp', '0002_simplify_models'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='mailchimpcontact',
            name='contact',
            field=models.ForeignKey(related_name='+', verbose_name='contact', blank=True, to='shoop.Contact', null=True),
        ),
